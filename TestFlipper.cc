...
//   EXPECT_NEAR(Collision::get_minimum_dist(&r1,&r2), 8, 0.001);
// }
...
//   EXPECT_NEAR(Collision::get_minimum_dist(&r1,&r2), 0, 0.001);
// }
...
//   EXPECT_NEAR(Collision::get_minimum_dist(&r1,&r2), 0.01, 0.001);
// }
